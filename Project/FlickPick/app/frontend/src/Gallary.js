    ...
    return (
        <div id = "Gallary">
            ...
            <div id='popularRecc'>
                ...
                <div className='flex'> 
                <button className={`movie-card ${swipeDirection === 'FeatDislike1' ? 'slide-out-up' : ''}`} onClick={() => handleSwipe('FeatDislike1')}>
                            <img src={movies[8].imgUrl} alt={movies[8].title} />
                        </button>
                        <button className={`movie-card ${swipeDirection === 'FeatDislike2' ? 'slide-out-up' : ''}`} onClick={() => handleSwipe('FeatDislike2')}>
                            <img src={movies[9].imgUrl} alt={movies[9].title} />
                        </button>                <button className={`movie-card ${swipeDirection === 'FeatDislike3' ? 'slide-out-up' : ''}`} onClick={() => handleSwipe('FeatDislike3')}>
                            <img src={movies[10].imgUrl} alt={movies[10].title} />
                        </button>                <button className={`movie-card ${swipeDirection === 'FeatDislike4' ? 'slide-out-up' : ''}`} onClick={() => handleSwipe('FeatDislike4')}>
                            <img src={movies[11].imgUrl} alt={movies[11].title} />
                        </button>                <button className={`movie-card ${swipeDirection === 'FeatDislike5' ? 'slide-out-up' : ''}`} onClick={() => handleSwipe('FeatDislike5')}>
                            <img src={movies[12].imgUrl} alt={movies[12].title} />
                        </button>                <button className={`movie-card ${swipeDirection === 'FeatDislike6' ? 'slide-out-up' : ''}`} onClick={() => handleSwipe('FeatDislike6')}>
                            <img src={movies[13].imgUrl} alt={movies[13].title} />
                        </button>                <button className={`movie-card ${swipeDirection === 'FeatDislike7' ? 'slide-out-up' : ''}`} onClick={() => handleSwipe('FeatDislike7')}>
                            <img src={movies[14].imgUrl} alt={movies[14].title} />
                        </button>                <button className={`movie-card ${swipeDirection === 'FeatDislike8' ? 'slide-out-up' : ''}`} onClick={() => handleSwipe('FeatDislike8')}>
